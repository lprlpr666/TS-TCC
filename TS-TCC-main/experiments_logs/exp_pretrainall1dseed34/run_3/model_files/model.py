...
class Conv1d_single2_Model(nn.Module):
    def __init__(self, configs):
        super(Conv1d_single2_Model, self).__init__()
        ...
        self.conv_block3 = nn.Sequential(
            nn.Conv1d(4 * 62, configs.final_out_channels, kernel_size=8, stride=1, bias=False, padding=4),
            nn.BatchNorm1d(configs.final_out_channels),
            nn.ReLU(),
            nn.MaxPool1d(kernel_size=2, stride=2, padding=1),
        )
