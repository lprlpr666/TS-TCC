...
class TC(nn.Module):
    def __init__(self, configs, device):
        ...
        # self.brain_location = nn.ModuleList([nn.Sequential(
        #     nn.Linear(65, 32),
        #     nn.ReLU(),
        #     nn.Linear(32,4)
        # ) 
    ...
    def forward(self, features_aug1, features_aug2):
        ...
        # print(seq_len)
        # exit(0)
        # batch size, channel, seq_len
        
        # loss_1 = 0
        # loss_2 = 0
        # cls_loss = nn.CrossEntropyLoss()
        # for batch_idx in range(z_aug1.shape[0]):
        #     pred_1 = self.brain_location[0](z_aug1[batch_idx])
        #     pred_2 = self.brain_location[1](z_aug2[batch_idx])
        #     loss_1 += cls_loss(pred_1, labels)
        #     loss_2 += cls_loss(pred_2, labels)
